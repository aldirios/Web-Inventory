...
<center>
    ...
    <div id="table">
        ...
        <i class="fas fa-chevron-circle-left"><a href="menu.php">Kembali</a></i>
    </div>
...
<script>
    ...
    //eksekusi ajax
    xhr.open("GET", "../ajax/searchBarang.php?admin=admin&keyword=" + keyword.value, true);
    xhr.send();
    });
